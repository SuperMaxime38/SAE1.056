...
function selectAgence(agence_id) {
    ...
    document.getElementById("agence-1").classList.remove("agence_selected");
    document.getElementById("agence-2").classList.remove("agence_selected");
    document.getElementById("agence-3").classList.remove("agence_selected");
    document.getElementById("agence-4").classList.remove("agence_selected");
    document.getElementById("agence-5").classList.remove("agence_selected");
    document.getElementById("agence-" + agence_id).classList.add("agence_selected");
